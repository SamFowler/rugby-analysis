...
base_url = 'http://stats.espnscrum.com/statsguru/rugby/stats/index.html?class=1;filter=advanced;orderby=date;size=200;template=results;type=team;view=match'

search_url = 'http://stats.espnscrum.com/statsguru/rugby/stats/index.html?class=1;filter=advanced;orderby=matches;page={page+1};size=200;spanmin1=27+Mar+1860;spanval1=span;team=1;template=results;type=player"'
save_dir = 'search_pages'
